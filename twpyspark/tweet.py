...
class TwitterApi(object):
    ...
    def get_tweets_of_topic(self, topic, count=10):
        ...
        tweets = [_clean_tweet(tw.text) for tw in tweets_status if tw.lang == "en"]
        return tweets
...
def main():
    ...
    topics_tweets = {topic: twitter_api.get_tweets_of_topic(topic, count=10) for topic in topics}
    pprint(topics_tweets)
